...
const basePath = '/bluesky-visualizers/planet/';

const lowPolyNatureCollectionModels: Record<string, { versions?: number; materials: string[] }> = {
	BirchTree: {
		versions: 5,
	...
	WoodLog_Moss: {
		materials: ['Brown', 'Green', 'Mushroom_Top', 'Mushroom_Bottom', 'DarkGreen']
	},
...
export function getModels(collection: Collections = 'lowpoly_nature'): string[] {
